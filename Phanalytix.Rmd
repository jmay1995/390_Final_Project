...
phanalytix <- phanalytix %>% 
    mutate(adjGap = ifelse(debut_dummy == 1,NA, 
...
```{r show duration, eval = FALSE}
time2 <- shows$duration[1513]
time2
#10690062
#2h 58m aka 2.9666667
time2 / 3600000
hour <- trunc(time2 / 3600000)
hour
minutes <- ((time2 / 3600000) - trunc(time2 / 3600000))*.6
minutes
adj_time2 <-  trunc(time2 / 3600000) + (((time2 / 3600000) - trunc(time2 / 3600000))*.6)
adj_time2
#0.1719207 17:11
